...
NIGHT_CRUISE = ExcursionData(
	...
	image_path="src/bot/data/images/excursions/emperor_cruise.jpg",
...
DALAT_VIP = ExcursionData(
	...
	image_path="src/bot/data/images/excursions/dalat_vip.jpg",
...
VINWONDERS = ExcursionData(
	...
	image_path="src/bot/data/images/excursions/vinwonders.jpg",
...
DIVING = ExcursionData(
	...
	image_path="src/bot/data/images/excursions/diving.jpg",
